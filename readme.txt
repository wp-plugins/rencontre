...
This WordPress plugin allows you to create a professional **dating website** with Wordpress. It is simple to install and administer. The features are as follows:
